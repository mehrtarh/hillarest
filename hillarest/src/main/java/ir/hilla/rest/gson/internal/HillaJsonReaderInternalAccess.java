...
/**
 * Internal-only APIs of HillaJsonReader available only to other classes in HillaGson.
 */
public abstract class HillaJsonReaderInternalAccess {
   ...
   */
  public abstract void promoteNameToValue(HillaJsonReader reader) throws IOException;
}
