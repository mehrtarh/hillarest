...
/**
 * An implementation of {@link HillaReflectionAccessor} based on {@link Unsafe}.
 * <p>
 * NOTE: This implementation is designed for Java 9. Although it should work with earlier Java releases, it is better to
 * use {@link HillaPreJava9ReflectionAccessor} for them.
 */
@SuppressWarnings({"unchecked", "rawtypes"})
final class HillaUnsafeReflectionAccessor extends HillaReflectionAccessor {
  ...
  public void makeAccessible(AccessibleObject ao) {
    ...
    if (!success) {
      try {
        ...
        throw new HillaJsonIOException("HillaGson couldn't modify fields for " + ao
