...
public abstract class HillaReflectionAccessor {
  ...
  private static final HillaReflectionAccessor instance = HillaJavaVersion.getMajorJavaVersion() < 9 ? new HillaPreJava9ReflectionAccessor() : new HillaUnsafeReflectionAccessor();
  ...
  /**
   * Obtains a {@link HillaReflectionAccessor} instance suitable for the current Java version.
   * <p>
   * You may need one a reflective operation in your code throws {@link java.lang.reflect.InaccessibleObjectException}.
   * In such a case, use {@link HillaReflectionAccessor#makeAccessible(AccessibleObject)} on a field, method or constructor
