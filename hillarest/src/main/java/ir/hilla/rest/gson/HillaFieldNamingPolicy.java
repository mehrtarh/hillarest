 ...
 * This enumeration should be used in conjunction with {@link HillaGsonBuilder}
 * to configure a {@link HillaGson} instance to properly translate Java field
 * names into the desired JSON field names.
 *
 * @author Inderjeet Singh
 * @author Joel Leitch
 */
public enum HillaFieldNamingPolicy implements HillaFieldNamingStrategy {

  /**
   * Using this naming policy with HillaGson will ensure that the field name is
   * unchanged.
   */
  IDENTITY() {
  ...
  /**
   * Using this naming policy with HillaGson will ensure that the first "letter" of the Java
  ...
  /**
   * Using this naming policy with HillaGson will modify the Java Field name from its camel cased
