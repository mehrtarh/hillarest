 ...
 */
public final class HillaLinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
  ...
  public HillaLinkedHashTreeMap(Comparator<? super K> comparator) {
   ...
   * value. To use:
   * <ol>
   *   <li>HillaRestCall {@link #reset} to initialize the target size <i>size</i>.
   *   <li>HillaRestCall {@link #add} <i>size</i> times with increasing values.
   *   <li>HillaRestCall {@link #root} to get the root of the balanced tree.
   * </ol>
   *
  ...
  final class EntrySet extends AbstractSet<Entry<K, V>> {
    ...
    @Override public void clear() {
      HillaLinkedHashTreeMap.this.clear();
    }
  }
   ...
   * it as a LinkedHashMap so that they won't need HillaGson on the other side to
